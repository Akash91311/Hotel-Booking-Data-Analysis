# Hotel Performance Dashboard - Analysis Of Hotel Booking Data
...
-- What trends we see in the data?<br />
-- Which are the key factors affecting the revenue?


## Steps to follow to get the Insights
